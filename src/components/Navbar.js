    ...
    <>
      ...
      {isMobile && (
        <div className={`mobile-menu ${isMenuOpen ? 'active' : ''}`}>
          <NavLink to="/home" className="mobile-nav-button" onClick={() => setIsMenuOpen(false)}>
            Inicio
          </NavLink>
          <NavLink to="/sales" className="mobile-nav-button" onClick={() => setIsMenuOpen(false)}>
            Ventas
          </NavLink>
          <NavLink to="/inventory" className="mobile-nav-button" onClick={() => setIsMenuOpen(false)}>
            Inventario
          </NavLink>
          <NavLink to="/staff" className="mobile-nav-button" onClick={() => setIsMenuOpen(false)}>
            Personal
          </NavLink>
          <NavLink to="/prediction" className="mobile-nav-button" onClick={() => setIsMenuOpen(false)}>
            Predicción
          </NavLink>
